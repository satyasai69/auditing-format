...
The internet is our documentation, and we want to treat it as such. **Every** _specific_ question we have _should_ be able to be found by typing it into a web search bar.
